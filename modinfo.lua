...
local counter_cooldown_options = {
    {description="0.5", data = 0.5},
    {description="0.63", data = 0.63},
...
configuration_options = {
	...
	{
        name = "ichimonji_key",
        label = en_zh("ICHIMONJI Button", "一文字 按键", "一文字 按鍵"),
        hover = en_zh("ICHIMONJI skill input.", "一文字剑技按键", "一文字劍技按鍵"),
        default = 118,
        options = keylist,
    },
	{
        name = "flip_key",
        label = en_zh("FLIP Button", "翻斩 按键", "翻斬 按鍵"),
        hover = en_zh("FLIP skill input.", "翻斩剑技按键", "翻斬劍技按鍵"),
        default = 98,
        options = keylist,
    },
	{
        name = "thrust_key",
        label = en_zh("THRUST Button", "突刺 按键", "突刺 按鍵"),
        hover = en_zh("THRUST skill input.", "突刺剑技按键", "突刺劍技按鍵"),
        default = 110,
        options = keylist,
    },
    {
		name = "ISSHIN",
		label = en_zh("ISSHIN Button", "一心 按键", "一心 按鍵"),
		hover = en_zh("ISSHIN skill input. \n FLIP -> ICHIMONJI", "一心剑技按键 \n 翻斩 -> 一文字", "一心劍技按鍵 \n 翻斬 -> 一文字"),
		options = {
            {description = en_zh("FLIP -> ICHIMONJI ", "翻斩 -> 一文字", "翻斬 -> 一文字"), data = 0, hover = ""},
        },
		default = 0,
	},
    {
		name = "HEAVENLYSTRIKE",
		label = en_zh("HEAVENLYSTRIKE Button", "天翔龙闪 按键", "天翔龍閃 按鍵"),
		hover = en_zh("HEAVENLYSTRIKE skill input. \n FLIP -> THRUST", "天翔龙闪剑技按键 \n 翻斩 -> 突刺", "天翔龍閃劍技按鍵 \n 翻斬 -> 突刺"),
		options = {
            {description = en_zh("FLIP -> THRUST ", "翻斩 -> 突刺", "翻斬 -> 突刺"), data = 0, hover = ""},
        },
		default = 0,
	},
    {
		name = "RYUSEN",
		label = en_zh("RYUSEN Button", "龙闪 按键", "龍閃 按鍵"),
		hover = en_zh("RYUSEN skill input. \n ICHIMONJI -> FLIP", "龙闪剑技按键 \n 一文字 -> 翻斩", "龍閃劍技按鍵 \n 一文字 -> 翻斩"),
		options = {
            {description = en_zh("ICHIMONJI -> FLIP ", "一文字 -> 翻斩", "一文字 -> 翻斩"), data = 0, hover = ""},
        },
		default = 0,
	},
    {
		name = "SUSANOO",
		label = en_zh("SUSANOO Button", "须佐 按键", "須佐 按鍵"),
		hover = en_zh("SUSANOO skill input. \n THRUST -> FLIP", "须佐剑技按键 \n 突刺 -> 翻斩", "須佐劍技按鍵 \n 突刺 -> 翻斩"),
		options = {
            {description = en_zh("THRUST -> FLIP ", "突刺 -> 翻斩", "突刺 -> 翻斩"), data = 0, hover = ""},
        },
		default = 0,
	},
    {
        name = "soryuha_key",
        label = en_zh("SORYUHA Button", "苍龙破 按键", "蒼龍破 按鍵"),
        hover = en_zh("SORYUHA skill input.", "苍龙破剑技按键", "蒼龍破劍技按鍵"),
        default = 104,
        options = keylist,
    },
	{
        name = "counter_attack_cooldown_time",
        label = en_zh("Counter Cooldown time(s).", "反击冷却时间", "反擊冷卻時間"),
        hover = en_zh("Set counter attack cooldown time.", "设置反击技能冷却时间", "設定反擊技能冷卻時間"),
        options = counter_cooldown_options,
        default = 0.63,
    },
	{
        name = "ichimonji_cooldown_time",
        label = en_zh("ICHIMONJI Cooldown time(s).", "一文字冷却时间", "一文字冷卻時間"),
        hover = en_zh("Set ICHIMONJI cooldown time.", "设置一文字冷却时间", "設定一文字冷卻時間"),
        options = skill_cooldown_options,
        default = 45,
    },
	{
        name = "flip_cooldown_time",
        label = en_zh("FLIP Cooldown time(s).", "翻斩冷却时间", "翻斬冷卻時間"),
        hover = en_zh("Set FLIP cooldown time.", "设置翻斩冷却时间", "設定翻斬冷卻時間"),
        options = skill_cooldown_options,
        default = 45,
    },
	{
        name = "thrust_cooldown_time",
        label = en_zh("THRUST Cooldown time(s).", "突刺冷却时间", "突刺冷卻時間"),
        hover = en_zh("Set THRUST cooldown time.", "设置突刺冷却时间", "設定突刺冷卻時間"),
        options = skill_cooldown_options,
        default = 45,
    },
    {
        name = "soryuha_cooldown_time",
        label = en_zh("SORYUHA Cooldown time(s).", "双龙破冷却时间", "雙龍破冷卻時間"),
        hover = en_zh("Set SORYUHA cooldown time.", "设置双龙破冷却时间", "設定雙龍破冷卻時間"),
        options = skill_cooldown_options,
        default = 45,
    },
	{
        name = "isshin_skill_cooldown_time",
        label = en_zh("ISSHIN Cooldown time(s).", "一心冷却时间", "一心冷卻時間"),
        hover = en_zh("Set ISSHIN and HEAVENLYSTRIKE cooldown time.", "设置一心和天翔龙闪冷却时间", "設定一心和天翔龍閃冷卻時間"),
        options = tier2_cooldown_options,
        default = 90,
    },
	{
        name = "ryusen_and_susanoo_skill_cooldown_time",
        label = en_zh("RYUSEN/SUSANOO Cooldown time(s).", "龙闪/须佐冷却时间", "龍閃/須佐冷卻時間"),
        hover = en_zh("Set RYUSEN and SUSANOO cooldown time.", "设置龙闪和须佐冷却时间", "設定龍閃和須佐冷卻時間"),
        options = tier3_cooldown_options,
        default = 210,
    },
    ...
    },
	{
        ...
        label = en_zh("Quick Sheath Katana", "快速收拔刀", "快速收拔刀"),
    ...
    },
    {
        ...
        label = en_zh("EyeGlasses 󰀅", "眼镜 󰀅", "眼鏡 󰀅"),
    ...
    },
	{
        ...
        label = en_zh("Change Hair Style 󰀖", "改变发型 󰀖", "改變髮型 󰀖"),
    ...
    },
	{
        ...
        label = en_zh("Show Level  󰀙", "查看人物等级  󰀙", "查看人物等級  󰀙"),
